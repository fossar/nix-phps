...
in
{
  ...
  extensions = prev.extensions // {
    ...
    soap = prev.extensions.soap.overrideAttrs (attrs: {
      ...
      doCheck = attrs.doCheck or true && (lib.versionOlder prev.php.version "7.4" -> pkgs.stdenv.hostPlatform.isLinux);
    ...
    xmlwriter = prev.extensions.xmlwriter.overrideAttrs (attrs: {
      ...
      doCheck =
        attrs.doCheck or true && (lib.versions.majorMinor prev.php.version == "7.3" -> pkgs.stdenv.hostPlatform.isLinux);
    });
